...
async function seed() {
  ...
  try {
    ...
    const users = [
      ...
      {
        id: uuidv4(),
        name: 'Amores Victor T. Baliad',
        email: 'amoresvictorbaliad@gmail.com',
        password_hash: passwordHash,
        phone: '09051264244',
      ...
      },
      {
        id: uuidv4(),
        name: 'Maria Valdez',
        email: 'maria.valdez@email.com',
        password_hash: userPasswordHash,
        phone: '09171234571',
        address: '90 Magsaysay Blvd.',
